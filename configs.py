...
URL = "https://bottom-katherina-rjfilestoreha-a892eb74.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://bottom-katherina-rjfilestoreha-a892eb74.koyeb.app/".format(FQDN, PORT)
...
STREAM_LOGS = environ.get('STREAM_LOGS','-100186675376')
...
class Config(object):
	...
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-100186675376"))
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-100186675376")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL","-100186675376")
	BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "1234567890").split())
	FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", False))
	BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", False))
	LAZY_CHANNEL = int(os.environ.get('LAZY_CHANNEL','-100186675376'))
